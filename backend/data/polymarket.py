...
CITY_CELSIUS: set[str] = {
    ...
    # ── Expansion cities (20 Celsius, 5 Fahrenheit — see CITY_SLUGS for °F cities) ──
    "Istanbul", "Moscow", "Helsinki", "Amsterdam",
    "Beijing", "Shenzhen", "Chengdu", "Wuhan", "Chongqing", "Guangzhou", "Busan",
